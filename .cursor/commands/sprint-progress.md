# /sprint-progress — segnale burndown del sprint corrente (EP-043 US-153)

Comando della capability [[task-analytics-cost-estimation-capability]] (faccia **Sprint Burndown**,
EP-043 US-153, opt-in `analytics.sprint_progress.enabled`). Mostra lo stato di avanzamento del
sprint corrente o di uno sprint specifico: conteggio TSK per stato, velocita' rolling e
proiezione al completamento. Delegato a `tools/analytics/sprint-progress.py`.
