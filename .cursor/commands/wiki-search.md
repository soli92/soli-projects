# /wiki-search — ricerca ibrida nel wiki (semantic + FTS)
...
Ricerca diretta nell'indice LanceDB senza passare dall'agente [wiki-query](mdc:.cursor/rules/wiki-query.mdc).
...
**Nota**: questo sotto-comando bypassa [wiki-query](mdc:.cursor/rules/wiki-query.mdc) — utile per testare l'indice in
