...
- **Skill invocata**: `.cursor/skills/content-share-protocol/SKILL.md`
- **Setup prerequisiti**: `wiki/runbooks/content-share-setup.md`
- **Hub destinazione**: `wiki/entities/soli-frames.md`
- **Configurazione**: `factory.config.yaml` blocco `content_share:`
